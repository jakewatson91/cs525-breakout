def add_arguments(parser):
    ...
    parser.add_argument('--epsilon_min', type=int, default=0.025, help='batch size for training')
    parser.add_argument('--decay_rate', type=float, default=0.0000004, help='learning rate for training')
